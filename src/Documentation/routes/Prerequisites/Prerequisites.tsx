export const Prerequisites = () => (
  <>
    <section>
      <h2 className="section__title--before-starting">
      ...
      <section>
        ...
        <ul className="block">
          <li>
            ...
            >
              Volta for running the required node version (reboot required)
            </a>
          </li>
        </ul>
      </section>
      <section>
        ...
        <p>
          To understand a little more on what this DOJO is about, explore a
          little bit{" "}
          <a
      ...
      <section>
        ...
        <section>
          ...
          <ul className="block">
            ...
            <li>
              <a
                href="https://www.npmjs.com/package/specflow-emulator"
                target="_blank"
                rel="noreferrer"
              >
                specflow-emulator
