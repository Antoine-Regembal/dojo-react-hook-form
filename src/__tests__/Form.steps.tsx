...
describe("Form", function () {
  ...
  const formIsSubmittedByClickingXButton = (
  ...
  const theXFieldHaveTheYErrorMessages = (
    defineStepFunction: DefineStepFunction
  ) =>
    defineStepFunction(
  ...
  defineFeature(feature, (test) => {
    ...
    test("Submitting an invalid form with empty fields", ({
      given,
      when,
      then,
      and,
    ...
    test('Quitting "<fieldLabel>" field with invalid empty value', ({
      given,
      and,
      when,
      then,
    ...
    test('Validating email field with invalid "<emailValue>" value', ({
      given,
      and,
      when,
      then,
    ...
    test('Validating invalid confirm email field with "foor.bar@email.com" and "foo.bar@email.com" value for email field', ({
      given,
      and,
      when,
      then,
